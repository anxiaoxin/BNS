...
var drawCircle = function(){
	...
	ctx.fillText('pig个数：'+pigNums+'个 已收服小圆:'+count+'个 anHip宽度为：'+anHip.r+' 速度为：'+anHip.speed,20,20);
	ctx.closePath();
